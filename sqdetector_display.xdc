...
set_property PACKAGE_PIN Y5 [get_ports clock]
...
#LED灯1的设置,用于输出dc
set_property PACKAGE_PIN H7 [get_ports dc]
set_property IOSTANDARD LVCMOS33 [get_ports dc]

#LED灯5~8的设置,用于输出c
set_property PACKAGE_PIN D5 [get_ports {c[3]}]
set_property PACKAGE_PIN A3 [get_ports {c[2]}]
set_property PACKAGE_PIN A5 [get_ports {c[1]}]
set_property PACKAGE_PIN A4 [get_ports {c[0]}]
